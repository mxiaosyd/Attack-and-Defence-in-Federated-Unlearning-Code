"""FedSweep reproduction: trigger inversion, filtering, and unlearning."""
...
class FedSweep(RecoveryMethod):
    ...
    def recover(self, context):
        ...
        detected, cluster_labels, entropy_norm = _cluster_clients_by_entropy_and_credit(
            entropies,
            credits,
        ...
        return RecoveryResult(self.name, recovered_model, {
            ...
            "method_note": "strict_v3_1_fedsweep_trigger_inversion_entropy_credit_weighted_kmeans_feature_unlearning_formal_aggregation",
        })
